export const FontLoader = () => (
  <style>{`
    ...
    /* 縦書き時の見出し調整 */
    .vertical-writing h1, .vertical-writing h2, .vertical-writing h3 {
      margin-left: 2.5em;
      font-weight: 700;
      line-height: 1.4;
    }
    ...
    .custom-scrollbar::-webkit-scrollbar-thumb { background-color: rgba(194, 65, 12, 0.4); border-radius: 4px; }
    .custom-scrollbar::-webkit-scrollbar-thumb:hover { background-color: rgba(194, 65, 12, 0.8); }
